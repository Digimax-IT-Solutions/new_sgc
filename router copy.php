...
$pages = [
    ...
    'print_apv' => 'views/admin/apv/`print`_apv.php',
    ...
    'purchasing_print_purchase_order' => 'views/purchasing/purchase_order/purchasing_print_purchase_order.php',
    'purchasing_void_purchase_order' => 'views/purchasing/purchase_order/purchasing_void_purchase_order.php',

    'purchasing_receive_item' => 'views/purchasing/receive_items/purchasing_receive_item_list.php',
    'purchasing_create_receive_item' => 'views/purchasing/receive_items/purchasing_create_receive_item.php',
    'purchasing_view_receive_item' => 'views/purchasing/receive_items/purchasing_view_receive_item.php',
