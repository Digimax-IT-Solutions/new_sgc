                ...
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="purchase_home">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="purchasing_purchase_order_list">Purchase Order</a></li>
                                <li class="breadcrumb-item active" aria-current="page">View Purchase Order</li>
                            </ol>
                        </nav>
                    </div>
                    <a href="purchasing_purchase_order" class="btn btn-secondary">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-3 order-details">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm" id="po_no"
                                                                name="po_no" <?php if ($purchase_order->po_status == 4): ?>
                                                                    value="<?php echo htmlspecialchars($newPoNo); ?>" readonly <?php else: ?>
                                                                    value="<?php echo htmlspecialchars($purchase_order->po_no); ?>"
                                                                    disabled <?php endif; ?>>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-8 order-details">
                                                        ...
                                                        <textarea class="form-control" id="memo" name="memo" rows="2"
                                                            ...
                                                            disabled><?= $purchase_order->memo ?></textarea>
                                                            ...
                                                            <?php if ($purchase_order): ?>
                                                                <?php foreach ($purchase_order->details as $detail): ?>
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text"
                                                                                class="form-control form-control-sm pr_no"
                                                                                name="pr_no[]"
                                                                                value="<?= htmlspecialchars($detail['pr_no']) ?>"
                                                                                readonly>
                                                                        </td>
                                                                        <td>
                                                                            <select
