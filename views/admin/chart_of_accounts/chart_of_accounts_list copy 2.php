                                    ...
                                    <li>
                                        ...
                                        <ul class="nested">
                                            <?php foreach ($types as $type_id => $group): ?>
                                                <li>
                                                    <span class="caret"><?= $group['type_name'] ?></span>
                                                    <ul class="nested">
                                                        <li>
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($group['accounts'] as $account): ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="account-description"><?= $account->account_description ?></td>
                                                                            <td class="text-end">
                                                                        ...
                                                                        <?php if (!empty($account->sub_accounts)): ?>
                                                                            <?php foreach ($account->sub_accounts as $sub_account): ?>
                                                                                <tr class="sub-account">
                                                                                    <td class="account-code"><?= $sub_account->account_code ?></td>
                                                                                    <td class="account-name"><strong><?= $sub_account->account_name ?></strong></td>
...
<style>
    ...
    .tree .table .sub-account {
        background-color: #f8f9fa;
        /* Light background for sub-accounts */
    }
