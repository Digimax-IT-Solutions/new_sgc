    ...
    if (isset($_GET['id'])) {
        ...
        if ($purchase_request) {
            ...
            if ($purchase_request) {
                ...
                $pdf->Cell(70, 5, 'Samuel C. Quindao', 0, 0, 'L'); // Name under 'Certified as to non-availability of stock'
                $pdf->Cell(70, 5, 'Ana Liza S. Parrilla', 0, 0, 'L'); // Empty cell under 'Verified by'
                $pdf->Cell(70, 5, 'Emmanuel Q. Cadungog', 0, 1, 'L'); // Empty cell under 'Approved by'

                // Third row with names/values
                $pdf->Cell(50, 5, '', 0, 0, 'L'); // Empty cell under 'Requisitioned by'
                $pdf->Cell(70, 5, 'Warehousing Superintendent', 0, 0, 'L'); // Name under 'Certified as to non-availability of stock'
                $pdf->Cell(70, 5, 'Audit & Budget Supervisor', 0, 0, 'L'); // Empty cell under 'Verified by'
                $pdf->Cell(70, 5, 'Asst. to Pres/Resident Manager', 0, 1, 'L'); // Empty cell under 'Approved by'
