        ...
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-3"><strong>Create</strong> FS Note Classification</h1>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="api/masterlist/fs_notes_classification_controller.php"
                                id="uomForm">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="Enter Fs Note Classification here" required="off">
                                    </div>
                                </div>
