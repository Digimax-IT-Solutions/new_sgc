...
Guard::restrictToModule('sales_order');
...
$page = 'sales_order'; // Set the variable corresponding to the current page
?>
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-3"><strong>Sales</strong> Order</h1>

                    <div class="d-flex justify-content-end">
                        <a href="sales_order" class="btn btn-secondary">
                        ...
                        <div class="card-body">
                            <form id="writeCheckForm" action="api/invoice_controller.php?action=add" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="invoice_terms">Ship to</label>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="tin">S.O #</label>
                                            <input type="text" class="form-control form-control-sm" id="tin" name="tin">
                                        </div>

                                        <div class="form-group">
                                            <label for="tin">P.O #</label>
                                            <input type="text" class="form-control form-control-sm" id="tin" name="tin">
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="invoice_date">Address</label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="invoice_terms">Rep</label>
                                            <select class="form-control form-control-sm" id="invoice_terms"
                                                name="invoice_terms">
