        ...
        <div class="container-fluid p-0">
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-2"><strong>Accounting Dashboard</strong></h1>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                $accountingItems = [
                                    ...
                                    ['icon' => 'file-text', 'title' => 'General Journal', 'link' => 'general_journal', 'description' => 'Record and view journal entries'],
                                    ['icon' => 'file-text', 'title' => 'Transaction Entries', 'link' => 'transaction_entries', 'description' => 'Enter and manage transactions'],
                                    ['icon' => 'bar-chart-2', 'title' => 'Trial Balance', 'link' => 'trial_balance', 'description' => 'View your trial balance report'],
                                    ['icon' => 'clipboard', 'title' => 'Audit Trail', 'link' => 'audit_trail', 'description' => 'Track changes and activities'],
                                ];
