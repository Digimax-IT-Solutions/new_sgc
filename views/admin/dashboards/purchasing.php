        ...
        <div class="container-fluid p-0">
            <div class="row mb-4">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="h3 mb-2"><strong>Purchasing Dashboard</strong></h1>
            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            <h5 class="card-title text-white">Total Purchase Orders</h5>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <h5 class="card-title text-white">Total Purchase Value</h5>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-info text-white">
                        <div class="card-body">
                            <h5 class="card-title text-white">Active Suppliers</h5>
                            <h3 class="mb-0 text-white">0</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <?php
                                $purchasingItems = [
                                    ['icon' => 'file-text', 'title' => 'Purchase Request', 'link' => 'purchase_request', 'description' => 'Create and manage purchase requests'],
                                    ['icon' => 'shopping-cart', 'title' => 'Purchase Order', 'link' => 'purchase_order', 'description' => 'Create and manage purchase orders'],
                                    ['icon' => 'clipboard', 'title' => 'Supplier Management', 'link' => '/supplier-management', 'description' => 'Manage supplier information and contracts'],
                                    ['icon' => 'bar-chart-2', 'title' => 'Purchasing Reports', 'link' => '/purchasing-reports', 'description' => 'View and generate purchasing reports'],
                                ];
