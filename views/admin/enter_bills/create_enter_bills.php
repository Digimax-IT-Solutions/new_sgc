            ...
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="enter_bills" class="btn btn-secondary">
                        ...
                        <div class="card-body">
                            <form id="writeCheckForm" action="api/invoice_controller.php?action=add" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="invoice_date">A/P Account</label>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="invoice_date">Bill Due Date</label>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="invoice_number">Vendor</label>
                                            <select class="form-control form-control-sm" id="customer_name"
                                                name="customer_name">
