...
<div class="main">
    ...
    <main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3"><strong>Accounts Payable</strong> Voucher</h1>
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                                    <h1 class="h3 mb-3"><strong>APV</strong></h1>
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <a href="create_enter_bills" class="btn btn-secondary">
                                            <i class="align-middle" data-feather="file-text"></i> Create New
                                        </a>
                                    </div>
                                </div>
                            </div>
