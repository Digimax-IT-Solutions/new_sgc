...
Guard::restrictToModule('input_vat');
                                    ...
                                    <?php if (isset($_GET['id'])) {
                                        ...
                                        if ($input_vat) { ?>
                                            <form method="POST" action="api/masterlist/input_vat_controller.php"
                                                ...
                                                <input type="hidden" name="id" value="<?= $input_vat->id ?>" />
                                                <!-- INPUT VAT -->
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="input_vat_name"
                                                            name="input_vat_name" placeholder="Enter Input Vat Name"
                                                            value="<?= $input_vat->input_vat_name ?>">
                                                    </div>
                                                    <!-- INPUT VAT ACCOUNT-->
                                                        ...
                                                        <select class="form-control" id="input_vat_account_id"
                                                            ...
                                                            <?php foreach ($accounts as $account): ?>
                                                                <option value="<?= $account->id ?>"
                                                                    <?= ($account->id == $input_vat->input_vat_account_id) ? 'selected' : '' ?>>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="input_vat_description"
                                                            ...
                                                            value="<?= $input_vat->input_vat_description ?>">
                                                    </div>
                                                    <!-- INPUT VAT RATE -->
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="number" class="form-control" id="input_vat_rate"
                                                            name="input_vat_rate" placeholder="Enter Input Vat Rate"
                                                            value="<?= $input_vat->input_vat_rate ?>">
                                                    </div>
                                                </div>
