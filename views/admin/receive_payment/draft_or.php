                ...
                <div class="col-12">
                    ...
                    <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="or_list" class="btn btn-lg btn-outline-secondary me-2 mb-2">
                                ...
                                <table class="table table-bordered" id="dataTable"
                                    ...
                                    <tbody>
                                        <?php foreach ($orPayments as $orPayment): ?>
                                            ...
                                            <?php if ($orPayment->status == 4): // Only include credits with status 4 ?>
                                            <tr>
                                                <td style="white-space: nowrap;"> <?= htmlspecialchars($orPayment->ci_no) ?></td>
                                                <td style="white-space: nowrap;">
                                                    <?= htmlspecialchars($orPayment->customer_name) ?></td>
                                                <td style="white-space: nowrap;">
                                                    <?= htmlspecialchars($orPayment->or_date) ?></td>
                                                <td style="white-space: nowrap;">
                                                    <?= htmlspecialchars($orPayment->payment_method) ?></td>
                                                    <td style="white-space: nowrap;">
                                                    <b>₱<?= number_format($orPayment->total_amount_due, 2, '.', ','); ?></b>
                                                </td>
                                                <td style="white-space: nowrap;"><?= htmlspecialchars($orPayment->check_no) ?>
                                                </td>
                                                <td class="text-center">
                                                        <?php
                                                        switch ($orPayment->status) {
                                                            case 4:
