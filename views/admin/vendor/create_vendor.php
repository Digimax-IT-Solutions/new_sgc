        ...
        <div class="container-fluid p-0">
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-3"><strong>Vendor</strong> Management</h1>
                        ...
                        <div class="card-body">
                            <form method="POST" action="api/masterlist/vendor_controller.php" id="vendorForm">
                                ...
                                <div class="row mb-3" hidden>
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control form-control-sm item-type select2" id="item_type"
                                            name="item_type">
                                            <?php foreach ($uniqueItemsArray as $itemType): ?>
                                                <option value="<?= htmlspecialchars($itemType) ?>"
                                                    data-account-id="<?= htmlspecialchars($itemType) ?>">
