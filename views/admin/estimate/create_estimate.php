...
Guard::restrictToModule('estimate');
...
$page = 'estimate'; // Set the variable corresponding to the current page
?>
        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-3"><strong>Estimates</strong></h1>

                    <div class="d-flex justify-content-end">
                        <a href="estimate" class="btn btn-secondary">
                        ...
                        <div class="card-body">
                            <form id="writeCheckForm" action="api/invoice_controller.php?action=add" method="POST">
                                ...
                                <div class="table-responsive-sm">
                                    ...
                                    <button type="button" class="btn btn-secondary" id="addItemBtn">Add
                                        Item</button>
                                </div>
                                <br><br>
                                <div class="row">
