...
Guard::restrictToModule('pay_bills');
...
$page = 'pay_bills'; // Set the variable corresponding to the current page
?>
                            ...
                            <div class="row">
                                <div class="col-sm-12 d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <a href="create_pay_bills" class="btn btn-secondary">
                                            <i class="align-middle" data-feather="file-text"></i> Pay Bills
                                        </a>
                                    </div>
                                </div>
                            </div>
