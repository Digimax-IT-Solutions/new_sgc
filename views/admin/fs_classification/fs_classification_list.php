...
<div class="main">
    ...
    <main class="content">
        <div class="container-fluid p-0">
            <h1 class="h3 mb-3"><strong>FS</strong> Classification</h1>
            <div class="row">
                <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="text-danger ml-2"
                                                        href="api/masterlist/fs_classification_controller.php?action=delete&id=<?= $fs_classification->id ?>">
    ...
    $(function () {
        $("#table").DataTable({
            ...
            "buttons": [
                ...
                {
                    extend: 'excel',
                    title: 'HISUMCO FS CLASSIFICATION LIST',
                    exportOptions: {
                        columns: ':not(:last-child)' // Exclude the last column (Action)
                    }
                },
