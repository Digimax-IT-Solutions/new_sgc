...
if (isset($_POST['import'])) {
    ...
    if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
        ...
        $sql = "INSERT INTO items (itemCode, itemName, itemType, preferredVendor, reOrderPoint, itemSalesInfo, itemSrp, itemPurchaseInfo, itemCost, itemCogsAccount, itemIncomeAccount, itemAssetsAccount, itemQty, uom, uom_set, itemSalesTaxCode, accumulated_depreciation, tax_agency, active_status) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
