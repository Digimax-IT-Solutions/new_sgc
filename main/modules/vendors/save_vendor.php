...
try {
    ...
    $query = "INSERT INTO vendors (vendorCode, vendorName, vendorAccountNumber, vendorAddress, vendorContactNumber, vendorEmail, vendorTerms) VALUES (:vendorCode, :vendorName, :vendorAccountNumber, :vendorAddress, :vendorContactNumber, :vendorEmail, :vendorTerms)";
