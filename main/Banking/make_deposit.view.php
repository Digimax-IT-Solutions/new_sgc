...
<div class="content-wrapper">
                            ...
                            <form id="enterBillsForm" name="enterBillsForm" method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="bankAccountName" id="bankAccountName" class="form-control"
                                            required>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <textarea name="memos" id="memos" class="form-control"
                                            rows="3">Deposit</textarea>
                                    </div>
                                </div>
                                <div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="makeDepositModal" tabindex="-1" role="dialog" aria-labelledby="makeDepositModalLabel"
        aria-hidden="true">
...
<script>
    $(document).ready(function () {
        function clearForm() {
            ...
            // Reset any form fields or input values
            $("#receivedFromInput").val("");
            $("#fromAccountInput").val("");
            $("#memoInput").val("");
            $("#checkNoInput").val("");
        ...
        $("#clearButton").click(function () {
            // Call the clearForm function when the button is clicked
            clearForm();
        });
        ...
        function checkForBills() {
            ...
            $.ajax({
                ...
                method: 'GET',
                dataType: 'json', // Specify JSON dataType to automatically parse response
                success: function (data) {
                    console.log('AJAX request successful:', data);
                    if (data.count > 0) {
                        // Bills found, show SweetAlert
                        Swal.fire({
                            icon: 'info',
                            title: 'Notification',
                            text: 'Payment found. Click OK to proceed.',
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: 'modules/banking/make_deposit/fetch_payment.php',
                                    method: 'GET',
                                    dataType: 'json',
                                    success: function (paymentData) {
                                        ...
                                        paymentData.forEach(function (row, index) {
                                            tableHtml += '<tr>' +
                                                '<td><input type="checkbox" id="' + row.ID + '" class="payment-checkbox" ' +
                                                ...
                                                '<td style="text-align: right">' + row.payment_amount + '.00</td>' +
