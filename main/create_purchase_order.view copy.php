                            ...
                            <form id="vendorForm" action="" method="POST">
                                <div class="form-row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-secondary"
                                                    ...
                                                    data-target="#vendorModal">Select</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h5 class="modal-title" id="vendorModalLabel">Select Vendor | <a
                                                            href="vendor_list">Add new
                                                            vendor</a></h5>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        ...
                                                        onclick="selectExistingVendor()">Select Vendor</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="date" class="form-control" id="poDueDate" name="poDueDate"
                                            required>
                                    </div>
